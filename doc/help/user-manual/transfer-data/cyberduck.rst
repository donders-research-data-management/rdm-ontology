...
If you are a Radboud University employee and have access to the Software Center, you can easily download CyberDuck via the :ref:`Software Center<https://www.ru.nl/ict-uk/staff/software/software-center/>`. Otherwise, you can download the installer from the software's website. Once downloaded, follow the instructions step-by-step while executing the installer.
